package com.ohgiraffers.Polymorphism.practice.controller;

import com.ohgiraffers.Polymorphism.practice.model.dto.AniBook;
import com.ohgiraffers.Polymorphism.practice.model.dto.Book;
import com.ohgiraffers.Polymorphism.practice.model.dto.CookBook;
import com.ohgiraffers.Polymorphism.practice.model.dto.Member;
import com.ohgiraffers.Polymorphism.practice.view.LibraryMenu;
...
// 검색 결과 도서 목록이 최대 5개일 수 있으니 임의로 크기 5 할당
        ...
        int count = 0;
// for문을 이용하여 bList 도서 목록들의 도서명(title)과 전달받은 keyword 비교
        for(int i = 0; i < bList.length; i++) {
            // equals()가 아닌 키워드를 포함해야해서 contains를 사용한다.
...
//// instanceof는 어떤 객체가 특정 크래스의 객체인지를 조사할 때 사용되는 자바의 내정 명령어
