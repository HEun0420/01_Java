...
public class Application06 {
    public static void main(String[] args) {
         ...
         * 반환값이 없을 때는 return;을 컴파일러가 자동으로 생성을 했지만,
         * 반환값이 있을 때는 return 구문을 반드시 명시적으로 작성해야한다.
         * 메소드의 선언분에 명시나 리턴 타입과, 반환값 자료형은 반드시 일치해야한다.
         */

        Application06 app6 = new Application06(); // 선언
        String returnTest = app6.testMethod(); // 리턴 타입 명시
