...
public class Application1 {
    public static void main(String[] args) {
        ...
        // java.util.Scanner scnner = new java.util.Scanner(System.in) ;

        Scanner sc = new Scanner(System.in); // 위쪽에 임포트 생김
...
//        System.out.println(num);
        ...
        * 정수형(long)
        *
        * nextLong() : 입력받은 값을 long형으로 바꿔준다.
         */

        System.out.print("원하는 월긃을 입력해주세요 : ");
        ...
        * 실수형(float)
        *
        * nexFloat() : 입력받은 값을 float형으로 반환해준다.
         */
        ...
        * 실수형(double)
        *
        * nextDobule() : 입력받은 값을 double형으로 반환해준다.
         */
        System.out.print("원주율(파이)를 아는 만큼 입력하세요.");
        double pi = sc.nextDouble();
        System.out.println("입력한 원쥬율은 " + pi + " 입니다.");
