package com.ohjiraffers.section03;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 모든 매서드는 static 메소드로 작성되어있다.
        ...
        System.out.println("20과 30중 더 큰 것은? " + Math.max(20, 30)); // 30

        System.out.println("원주율 : " + Math.PI); // 3.14~
        ...
        * 호출 할 때마다 다른 값을 가진다.
         */
        System.out.println("난수의 발생: " + Math. random());
