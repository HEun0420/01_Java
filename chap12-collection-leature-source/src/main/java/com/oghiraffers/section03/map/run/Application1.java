package com.oghiraffers.section03.map.run;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *
        * 키(key)
        * 값(value)를 찾기 이한 이름 역살을 하는 객체를 의미한다.
        * 1. 요소의 저장 순서를 유지하지 않는다.
        * 2. 키는 중복을 허용하지 않지만, 키가 다르면 중복되는 값은 저장 가능하다.
        *
        * HashMap, HashTable, TreeMap 등 대표적인 클래스가 존재한다.
        * HashMap이 가장 많이 사용되며 HashTavle은 jdk 1.0부터 존재해,
        * Hashmap과 동일하게 동작된다 => 하위호환을 위해 남겨놓는 것
        * 따라서, 가급적이면 HashMap을 사용하는 것이 권장된다.
        ...
        // put()
        // 키와 값 둘 다 객체여야한다.
        // atuoBoxing 처리 된다. 12 ==> new Integer12(12)
