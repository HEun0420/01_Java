...
public class Application3 {
    public static void main(String[] args) {
        /*
        * Stack
        * 후입선출(LIFO- Last In First Ou) 방식의 자료구조
         */
...
//        integerStack.add(6);
        ...
        System.out.println("integer: " + integerStack);
        ...
        * 가장 상단의 위치가 0이 아니라 1부터 시작.
         */
        System.out.println("intergerStack.search(5) : " +integerStack.search(5));
        ...
        * pop() : 해당 스택의 가장 마지막에 있는 요소 반환, 반환 후 제거
        ...
        System.out.println("peak() : " + integerStack.peek()); // 12345
        System.out.println("pop() : " + integerStack.pop()); // 5
        System.out.println("pop() 이후 intergerStack : " + integerStack); // [1234]  위의 전에 제거
...
//        System.out.println("pop() : " + integerStack.pop()); //  EmptyStackException
        ...
        System.out.println(integerStack);  // [] 비어짐
