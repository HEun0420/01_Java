...
public class Application4 {
    public static void main(String[] args) {
        ...
        * Queue 인터페이스를 상속받는 하위 인터페이들
        * Deque, BlockingQueue, TransferQueue 등
        * 대부분의 큐는 LinkedList를 이용한다.
         */
        // Queue는 인터페이스이기 때문에 자체로 인스턴스 생성이 불가능
//        Queue<String> que = new Queue<String>();
    ...
    // offer()를 통해 데이터를 넣는다.
        ...
        System.out.println("que = " + que);  // [first,second ... fifth]
        ...
        * poll() : 해당 큐에 가장 앞에 있는 요소(먼저 들어온 요소)를 반환, 반환 후 제거
        ...
        System.out.println("poll() : " + que.poll());   // first -> 나오고 지움
        System.out.println("que = " + que);   // [second, ... firth] // first 지워짐
