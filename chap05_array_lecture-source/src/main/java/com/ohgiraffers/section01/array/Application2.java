...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 자료형 변수명[];
        ...
        /*
        * 선언한 레퍼런스 변수에 배열을 할당하여 대압할 수 있다
        ...
        * -> 동일객체인지 비교할 때 사용할 목적으로 많이 쓰이며, 동등객체를 동일객체 취급하기 위한 용도로 overring 해서 사용된다.
        *
         */
        System.out.println("iarr2의 hashcode : " + iarr2.hashCode() );
        System.out.println("cahr2의 hashcode : " + carr2.hashCode() );


        // 배열의 길이를 알 수 있는 기능을 필드로 제공하고 있다.
        System.out.println("iarr의 길이 : " + iarr.length); // 배열의 길이가 5면 인덱스는 4
        System.out.println("carr2의 길이 : " + carr2.length); // 10
        ...
        System.out.println("darr의 hashcore : " + darr.hashCode());
        ...
        System.out.println("변경된 darr의 hashcore : " + darr.hashCode());
        System.out.println("변경된 darr의 길이: " + darr.length);

        // 한번 찾아갈 수 있는 주소값을 잃어버린 배열은 다시 참조가 불가능하다.
        darr = null;
