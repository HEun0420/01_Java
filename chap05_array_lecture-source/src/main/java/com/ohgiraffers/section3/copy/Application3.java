...
public class Application3 {
    public static void main(String[] args) {
        ...
        *   -> clone()이외 다른 복사 방법은 배열의 길이를 조절 가능
        ...
        // 원본 배열 할당 및 초기화
        int[] orignArr = new int[]{1,2,3,4,5};
...
//        print(copyArr2);
        ...
        System.arraycopy(copyArr2, 0, copyArr3, 0, copyArr2.length);

        // print(copyArr3); // 복사한 만큼의 값은 같지만, 길이도 다르고, 주소도 다르다.

        //Arays의 copyOf() 사용한 복사
        //시작한 인덱스부터 원하는 길이마큼 복사 가능
        int []  copyArr4 = Arrays.copyOf(orignArr, 9);
