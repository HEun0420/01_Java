...
public class Application1 {
    public static void main(String[] args) throws Exception {
        ...
        /*
         * 오류 (Error)
         * 시스템 상에서 프로그램에 심각한 문제를 발생시켜 실행중인 프로그램이 종료되는 것.
         * 이러한 오류는 개발자가 미리 예측하여 처리하는 것이 불가능 하며,
         * 오류에 대한 처리는 할 수 없다.
         * 예외 (Exception)
         * 오류와 마찬가지로 실행중인 프로그램을 비정상적으로 종료시키지만,
         * 발생할 수 있는 상황을 미리 예측하고 처리할 수 있는 미약한 우류를 의미한다.
         * 개발자는 이러한 예외에 대한 예외 처리를 통해 예외 상황을 적절히 처리하여
         * 코드의 흐름을 컨트롤한다.
         */
         ...
         *
         * 예외 처리 방법
         * 1. throws로 위임(나를 보호한 곳으로 예외를 던진다.)
         * 2. try-catch 로 처리
         */
