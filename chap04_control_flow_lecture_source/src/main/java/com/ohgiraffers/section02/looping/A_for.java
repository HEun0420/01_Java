...
//    }
        ...
        // int i는 시작선언, i를 제한하는 조건식==>없으면 무한으로 증가, i의 증감식 수를 정하기( i+= N)
    ...
    public void textExample2(){
        ...
        * 1부터 10까지 1씩 증가시키면서, 값을 저장할 변수(total)에 계속 누적시켜 저장된 값을 출력하세요.
        ...
        // 위의 식을 빠르게 total를 구하고 싶다면, 어떤걸 반복하면 좋을지?
...
//        System.out.println("1번째 학생의 이름은 "+ student1+"입니다." );
        ...
        // 위의 식으로 10명을 받으려면 위의 n번째 식을 10번 복사해서 n의 수와 student N의 수를 바꾸면서 해야한다.
        // 이를 간소화 시키기 취한 것이 포문
...
public void testExample4(){
    ...
    if(first > second) {
        ...
        System.out.println(first+"에서 부터 "+ second+"까지의 total = " + total);
}
