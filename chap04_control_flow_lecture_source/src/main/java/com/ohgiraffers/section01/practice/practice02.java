...
을 출력한다.
     */
        ...
        System.out.println("영어 점수는 몇 점 입니까?");
        int english = sc.nextInt();
        System.out.println("수학 점수는 몇 점 입니까?");
        int math = sc.nextInt();

        int gradeAverage = (math + english) / 2;
//        int gradeAverage =sc.nextInt();

        if (gradeAverage < 60) {
            System.out.println("시험 불합격");
        } else if (gradeAverage >= 60 && math < 60) {
            System.out.println("한 과목 과락으로 인한 불합격");
        } else if (gradeAverage >= 60 && english < 60) {
            System.out.println("한 과목 과락으로 인한 불합격");
        } else if (gradeAverage >= 60 && math >= 60 && english >= 60) {
