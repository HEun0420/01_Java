...
public class Application {
    ...
    public static void main(String[] args) {
        /*
        * 제네릭 (Generic)
        * 제네릭의 사전전인 의미는 "일반적인"이라는 의미
        * 자바에서 제네릭이란 데이터의 타입을 일반화 한다는 의미를 가지고 있다.
        *
        * 제네릭 프로그래밍
        * 데이터의 형식에 의존하지않고 하나의 값이 다른 데이터 타입들에 가질 수 있는 기술에
        * 중점을 두어 재사용성을 높일 수 있는 프로그래밍 방식
        *
        * 제네릭은 클래스나 메소드에서 사용할 내부 데이터 타입을 컴파일 시에 저장하는 방법을 의미한다.
