...
public class Application {
    public static void main(String[] args) {
         ...
         * 이때 메시지(메소드)를 보내는 쪽은 송신자, 메시지(메소드)를 수신하는 족은 수신자라고 한다.
         * 수신자는 메세지를 전달 받아 그 메세지에 해당하는 내용을 처리하는 방법을
         * 스스로 결정하고, 그 결정할 방법 대로 처리할 명령어들을 순차적으로 기술한 것 => 메소드
         *
         * 상호작용에 중요한 것은 메세지를 송수신하고 그 방법을 기술하여 메세지에 응답하는 상호작용을 설계하는 것
         ...
         *
         * 2. 객체간 상호작용
         * 1) 카레이서가 수신할 수 잇는 메세지 (카레이서가 해야하는 일) -> 자동차를 움직이게 해야함.
         *   - 사동을 걸어라
         *   - 엑셀러레이터를 밟아라
         *   - 브레이크를 밞아라
         *   - 시동을 꺼라
         *
         * 2) 자동차가 수신할 수 있는 메세지(자동차가 해야하는 일)
         *   - 시동을 걸어라
         *   - 앞으로 가라
         *   - 멈춰라
         *   - 시동을 꺼라
         ...
         * 2) 가속 하기
         *   - 사용자가 --> 엑셀레이터를 밟아라 --> 카레이서 --> 앞으로 가라 -->자동차
         * 3) 정지하기
         *   - 사용자 --> 브레이크를 밟아라 --> 카레이서 --> 멈춰라 --> 자동차
         * 4) 시동 끄기
         *   - 사용자 --> 시동을 거라 --> 카레이서 --> 시동을 꺼라 --> 자동차
         *
         * 4. 클래스 설계하기
         * 1) 카레이서 클래스
         *   - 속성:
