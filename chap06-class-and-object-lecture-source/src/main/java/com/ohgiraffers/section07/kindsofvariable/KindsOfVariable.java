...
public class KindsOfVariable {
    ...
    * 필드 == 멤버변수(클래스가 가지는 변수) == 전역변수(클래스 전역에서 사용할 수 있는 변수)
    ...
    // static field, 정적 필드(클래스 변수)라고 한다. (정적(클래스) 영역에 생상되는 변수라는 의미)
...
//        System.out.println(localNum); // 지역 변수는 해ㅇ당 지역(블럭)에서만 사용 가능하다.
        System.out.println(globalNum); // 전역 변수는 다른 메소드에서도 가능하다.
        System.out.println(staticNum);
    }
