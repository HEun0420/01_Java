package com.ohgiraffers.scetion01.user_type;
...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
        * 위와같이 각각의 변수로 관리하게되면 몇가지 단점이 있다.
        * 1. 변수명을 다 관리해야한다.
        * 2. 모든 회원 정보를 인자로 메소드 호출시, 값을 전달해야하면,
        *       너무 많은 값을 인자로 전달해야해서 가독성이 떨어진다.
        ...
        *
        * [자료형] [변수명] = new [클래스명]();
        * 사용자 정의 자료형인 클래스를 이용하기 위해서는 new 연산자료  heap에 할당을 해야한다.
        ...
        * 배열은 인덱스로 접근, 객체는 필드명으로 접근한다.
        ...
        System.out.println("member. pwe: " + member.pwd);
        ...
        for(int i = 0; i < member.hobby.length; i++) {
            System.out.println(member.hobby[i] +i + " ");
        }
        System.out.println();
    }
