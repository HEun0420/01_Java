package com.ohgiraffers.section4.wrapper;
...
//        long price; // -> 0 // null
        ...
        /*
        * 박싱(Boxing)과 언박식(UnBoxing)
        * 기본타입에서 래퍼클래스의 인스턴스로 인스턴스화 하는 것을 박싱
        * 래퍼클래스 타입의 인스턴스를 기본타입으로 변경하는 것을 언박싱
         */
...
//        Integer boxingNumber1 = new Integer(intValue);  // 생성자로 박싱
        ...
        * 이런 자동화된 박싱과 언박싱을 오토 박싱, 오토 언박싱이라고 한다.
         */
        ...
        System.out.println("IntegerNum1와 IntegerNum3 비교" + (integerNum1 == integerNum3)); // ture
