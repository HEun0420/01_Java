package com.ohgriraffers.section04.comparison;
...
public class Application {
    public static void main(String[] args) {
        ...
        * 비교연산자
        *
        * 비교연산자는 피연산자 사이에 상대적인 크기를 판단해 참 혹은 겆시을 반환하는 연산자이다.
        * 연산자 중 참 혹은 거짓을 반환하는 연산자는 삼항연산자의 조것ㄴ식이나 조건문의 조건절에 많이 사용된다.
         */
        ...
        * '>=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같거나 크면 true 아니면 false를 반환
        * '<' : 왼쪽의 피연산자와 오른쪽의 피연산자보다 작으면 true 아니면 false를 반환
        * '<=' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같거나 작으면 true 아니면 false를 반환
         */
